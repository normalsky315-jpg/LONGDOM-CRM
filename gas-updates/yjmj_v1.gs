...
const CONFIG = {
  ...
  PROJECT_NAME:   '遠見沐景',
  SPREADSHEET_ID: '請貼上遠見沐景試算表的_SPREADSHEET_ID'
};
...
// setLineToken('請貼上遠見沐景的LINE_CHANNEL_ACCESS_TOKEN');
// setLinePushTarget('請貼上要接收推播的LINE_userId');
// setLineChannelSecret('請貼上遠見沐景的LINE_CHANNEL_SECRET');

function addMyself() {
  addUser('請貼上你的LINE_userId', '請填你的名字', 'admin', '遠見沐景');
}
